...
Blockscout (Sepolia)	Verificado	Ver contrato
Sourcify	Verificado	Ver contrato
Etherscan (Sepolia)	Pendiente de API key	Ver contrato
...
10. Conclusiones
El contrato SistemaCredencialesUNQ cumple con el modelo funcional del TP: roles institucionales, emisión de credenciales como NFT, verificación pública y revocación.
La naturaleza Soulbound garantiza que los títulos no puedan transferirse entre wallets, reforzando la vinculación alumno–credencial.
El esquema de privacidad por hash evita exponer nombre y DNI en texto plano en la blockchain.
La batería de 9 tests automatizados alcanza 100% de cobertura de líneas y statements, superando ampliamente el umbral del 80% exigido en el TP.
El contrato está desplegado y verificado en Ethereum Sepolia (Blockscout y Sourcify).
11. Referencias
OpenZeppelin Contracts — AccessControl
OpenZeppelin Contracts — ERC721
Hardhat 3 — Solidity Tests
Ethereum Sepolia Testnet
Repositorio del proyecto: UVQ-VNT
